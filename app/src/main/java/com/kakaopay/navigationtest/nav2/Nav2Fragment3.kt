...
import kotlinx.android.synthetic.main.fragment_nav2_3.view.*

/**
 * A simple [Fragment] subclass.
 */
class Nav2Fragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_nav2_3, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        view.nav2_3.setOnClickListener {
            Log.e("-----", "-----------------------------------")
            findNavController().graph =
                findNavController().navInflater.inflate(R.navigation.navigation1)
        }
    }
